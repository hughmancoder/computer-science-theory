...
std::string Karatsuba::schoolSubtraction(std::string a, std::string b,
                                         int Base) {
...
std::string Karatsuba::schoolMultiplication(std::string a, std::string b,
                                            int base) {
  int n = b.size();
  std::string offset = "";
  std::string res = "";
...
std::string Karatsuba::karatsuba(std::string a, std::string b, int B) {
  ...
  std::string p2 =
      karatsuba(schoolAddition(a_h, a_l, B), schoolAddition(b_h, b_l, B), B);
  std::string p3 =
      schoolAddition(karatsuba(a_h, b_h, B), karatsuba(a_l, b_l, B), B);
