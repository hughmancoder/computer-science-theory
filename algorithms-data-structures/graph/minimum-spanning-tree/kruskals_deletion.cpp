...
public:
  ...
  int find(int i) {
    ...
    // path compression: recursively update the nodes connecting to parent to
    // contain parent root
  ...
  void Union(int a, int b) {
    ...
    if (parent_a != parent_b) {
      // rank denots the height of the tree, so we want to connect the shorter
      // struct to flatten it out
