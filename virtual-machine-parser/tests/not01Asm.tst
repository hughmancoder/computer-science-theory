// not01 Test file; compares with the results from generated from the VM test file.
...
repeat 19 {    // Change this number to cover the number of instructions in the asm test file
    ticktock;
}
